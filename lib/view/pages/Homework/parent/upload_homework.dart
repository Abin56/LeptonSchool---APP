...
import 'package:lepton_school/view/pages/Homework/parent/upload_part.dart';
...
class UploadHomeworkParent extends StatelessWidget {
  const UploadHomeworkParent({
    super.key,
  ...
  Widget build(BuildContext context) {
    final HomeWorkListController homeWorkController = Get.put(HomeWorkListController());
    return Scaffold(
      backgroundColor: const Color.fromARGB(255, 255, 255, 255),
      appBar: AppBar(
        title: Row(
          children: [kHeight20, GooglePoppinsWidgets(text: "Submit HomeWork".tr, fontsize: 20.h)],
        ),
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) {
                                return UploadHomeworkToTeacherParent(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          snapshot.data!['Status'] == true ? "Completed" : "Not Completed",
                          style: TextStyle(
                            fontSize: 20.h,
                            fontWeight: FontWeight.bold,
                          ),
