...
import 'package:lepton_school/view/pages/chat/group_chats/student_group/chats/chat_appBar.dart';
                                ...
                                if (snaps.data!.docs.isEmpty) {
                                  ...
                                  return ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ///////////////////////////////////
                                      return teacherGroupChatController.messageTitles(
                                          size,
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        SizedBox(
                                          ...
                                          child: TextField(
                                            controller:
                                                teacherGroupChatController.messageController,
                                        ...
                                        FutureBuilder(
                                            ...
                                            builder: (context, userName) {
                                              if (userName.hasData) {
                                                return Obx(() => !teacherGroupChatController
                                                        .isLoading.value
                                                    ? CircleAvatar(
                                                        radius: 28,
                                                        backgroundColor: adminePrimayColor,
