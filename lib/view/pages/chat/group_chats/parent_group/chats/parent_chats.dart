...
import 'package:lepton_school/controllers/group_chat_controller/group_ParentsTeacher_chat_controller.dart';
...
class ParentsGroupChats extends StatefulWidget {
  ...
  const ParentsGroupChats({required this.groupId, required this.groupName, super.key});
...
class _ParentsGroupChatsState extends State<ParentsGroupChats> {
  ...
  @override
  void initState() {
    userIndexBecomeZero(widget.groupId, 'Parents', teacherParameter: 'parentName');
    super.initState();
  }
      ...
      appBar: AppBar(
        title: Row(
          children: [
            GestureDetector(
                onTap: () {
                  showParentsGroupAppBar(widget.groupName, '10', widget.groupId, context);
                },
              ...
              if (checkingParticipantssnaps.data!.docs.isEmpty) {
                return Center(
                  child: TextButton.icon(
                      onPressed: () async {
                        teacherParentGroupChatController.addParticipants(widget.groupId);
                      },
                                ...
                                if (snaps.data!.docs.isEmpty) {
                                  ...
                                  return ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ///////////////////////////////////
                                      return teacherParentGroupChatController.messageTitles(
                                          size,
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        SizedBox(
                                          ...
                                          child: TextField(
                                            controller:
                                                teacherParentGroupChatController.messageController,
                                        ...
                                        FutureBuilder(
                                            ...
                                            builder: (context, userName) {
                                              if (userName.hasData) {
                                                return Obx(() => !teacherParentGroupChatController
                                                        .isLoading.value
                                                    ? CircleAvatar(
                                                        radius: 28,
                                                        backgroundColor: adminePrimayColor,
