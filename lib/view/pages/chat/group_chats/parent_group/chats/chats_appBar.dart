                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                                "Group ${snaps.data!.docs.length} participants"),
                            Row(
                              children: [
                                Padding(
                            ...
                            SizedBox(
                              ...
                              child: Row(
                                children: [
                                  GooglePoppinsWidgetsNotice(
                                    text:
                                        '${snaps.data!.docs.length}  participants',
                                    fontsize: 15,
                                    fontWeight: FontWeight.w500,
                                  ),
                                  const SizedBox(
                                                      ...
                                                      return AlertDialog(
                                                        ...
                                                        actions: <Widget>[
                                                          TextButton(
                                                            ...
                                                            onPressed:
                                                                () async {
                                                              await teacherParentGroupChatController.removeParentToGroup(
                                                                  parentssnapshots
                                                                          .data!
                                                                          .docs[index]
                                                                      ['docid'],
